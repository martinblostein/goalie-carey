...
exceptionally-good play. See here an image often posted on the Habs subreddit the day after 
a Saturday night win:
...
percentage than any other night. Notice that only on Tuesdays, Thursdays and Saturdays does Carey 
come away with a win the  majority of the time. Interestingly, Friday is Carey's worst night,
and it is the only night with more regulation losses than wins (Sunday and Wednesday are exactly even).

There's one problem: by looking at percentages only we may have a skewed idea of what is going
on. This prelative view, while optimal for comparing days of the week, sells short how much Carey
